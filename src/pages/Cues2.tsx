...
// if spoken it will last for 0.5 seconds more 
  ...
  const [url1,setUrl1] = useState<string>("https://tso4smyf1j.execute-api.ap-south-1.amazonaws.com/test/transcription-2way-clientaudio")
  ...
  return (
    <div className="App">
        ...
        <div >
            ...
            <select id="cars" onChange={e=>setResponseType(e.target.value)} style={{fontSize:"1.5rem"}}>
